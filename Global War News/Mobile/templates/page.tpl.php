...
<!-- ---------------End Slide---------------  -->
	        <?php if ($page['content_top']): ?>
	        	<div id="content_top-left"><?php print "Posted: " . format_date($node->created, 'custom', 'F j, Y, g:i a'); ?> | <?php if ($node->changed != null){ print "Last Updated: " . format_date($node->changed, 'custom', 'F j, Y, g:i a'); } ?>
					<br>
