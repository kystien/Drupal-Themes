 ...
 *   The form state.
 */
function global_war_mobile_form_system_theme_settings_alter(&$form, &$form_state) {
  ...
  $form['prof_settings']['defcon'] = array(
    '#type' => 'fieldset',
    '#title' => t('Defcon Threat Level'),
	'#description'   => t("Select the daily threat level."),
    '#collapsible' => TRUE,
    '#collapsed' => FALSE,
  );
    $form['prof_settings']['defcon']['threat_level1'] = array(
    '#type' => 'checkbox',
    '#title' => t('Threat Level Red'),
    '#default_value' => theme_get_setting('threat_level1'),
    '#description'   => t("Major action expected, nukes may be used"),
  );
  $form['prof_settings']['defcon']['threat_level2'] = array(
    '#type' => 'checkbox',
    '#title' => t('Threat Level Orange'),
    '#default_value' => theme_get_setting('threat_level2'),
    '#description'   => t("Major action expected, no nukes"),
  );
  $form['prof_settings']['defcon']['threat_level3'] = array(
    '#type' => 'checkbox',
    '#title' => t('Threat Level Yellow'),
    '#default_value' => theme_get_setting('threat_level3'),
    '#description'   => t("Above average day of combat"),
  );
    $form['prof_settings']['defcon']['threat_level4'] = array(
    '#type' => 'checkbox',
    '#title' => t('Threat Level Green'),
    '#default_value' => theme_get_setting('threat_level4'),
    '#description'   => t("Average day of combat"),
  );
    $form['prof_settings']['defcon']['threat_level5'] = array(
    '#type' => 'checkbox',
    '#title' => t('Threat Level Blue'),
    '#default_value' => theme_get_setting('threat_level5'),
    '#description'   => t("General Peace, Below average combat"),
  );
