 ...
 */
function global_war_mobile_html_head_alter(&$head_elements) {
 ...
 */
function global_war_mobile_breadcrumb($variables) {
 ...
 */
function global_war_mobile_preprocess_page(&$vars) {
  ...
  if (drupal_is_front_page() || theme_get_setting('slideshow_all')) {
    $directory = drupal_get_path('theme', 'global_war_mobile');
 ...
 */
function global_war_mobile_menu_local_tasks(&$variables) {
  $output = '';
...
function global_war_mobile_preprocess_block(&$variables) {
 ...
 */
function global_war_mobile_preprocess_node(&$variables) {
  $node = $variables['node'];
  if ($variables['view_mode'] == 'full' && node_is_page($variables['node'])) {
    $variables['classes_array'][] = 'node-full';
  }
}
function global_war_mobile_preprocess_taxonomy_term(&$variables) {
