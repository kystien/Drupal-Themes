...
<!-- ---------------End Slide---------------  -->
   ...
   <div class="content-sidebar-wrap">
    ...
    <?php if ($page['sidebar_first']): ?>
		...
		<br>
		<br>
      	<?php print "Article Posted: " . format_date($node->created, 'custom', 'F j, Y, g:i a'); ?>
      	<br>
      	<?php if ($node->changed != null){
      	print "Article Updated: " . format_date($node->changed, 'custom', 'F j, Y, g:i a');
		} ?>
		<br>
      ...
      <aside id="sidebar-first" role="complementary">
        <center></center><?php print render($page['sidebar_first']); ?></center>
      </aside>  <!-- /#sidebar-first -->
    <?php endif; ?>
    </div>
