...
<!-- ---------------End Slide---------------  -->
       ...
       <!-- ~~~~~ Analysis & Opinions of World Events Section Blocks ~~~~~ -->
			<div id="third_whole">
				<div id="third_block">
					<div id="ano-heading">
						...
						<hr class="blue-divider_third_mid">
					</div>
		<!-- ~~~~~ Analysis Block ~~~~~ -->		
					<div id="third_half_block">
		...
		<?php endif; ?>
						<div class="opinion_footer"><a href="/Opinion" title="View Individual Opinions of world events">more&nbsp;&nbsp;<i class="fas fa-angle-double-right"></i></a></div>
					</div>
				</div>
			</div>
       <!-- ~~~~~ End Analysis & Opinions of World Events Section Blocks ~~~~~ -->
        		...
        		<div id="first_whole">
					<div id="battlefield-heading">
				    	...
				    	<center><hr class="blue-divider-bu"></center>
					</div>
			...
			<?php  if ($page['first_bottom'] || $page['second_bottom'] || $page['third_bottom'] || $page['fourth_bottom']): ?>
				...
				<?php if ($page['fourth_bottom']): 
						print render($page['fourth_bottom']);
 						...
 						<div class="cyber_footer"><a href="/AO/CYBERWAR" title="View All Cyberwar Battlefield News">more&nbsp;&nbsp;<i class="fas fa-angle-double-right"></i></a></div>
 					</div>
 				<!-- ~~~~~ End Cyber Block ~~~~~ -->
			<?php endif; ?>
				</div>
				...
				<div id="second_block">
					<div class="second_header_block">
						...
						<div id="politics-heading">
							<h1 class="politics-heading">Geopolitics</h1>
						</div>
						<center><hr class="blue-divider_second"></center>
					</div>
			...
			<?php endif; ?>
       				 ...
       				 <div class="second_footer_block">
 						<div class="business-footer">
 							<a class="view-all_second" href="/BUSINESS" title="View All Business News">more&nbsp;&nbsp;<i class="fas fa-angle-double-right"></i></a>
 						</div>
 						 <div class="politics-footer">
 							<a href="/GEOPOLITICS" title="View All Political News">more&nbsp;&nbsp;<i class="fas fa-angle-double-right"></i></a>
 						</div>
 					</div>
       			</div>
			</div>
       ...
       <!-- ~~~~~ History Special Section Blocks ~~~~~ -->
   			<div id="fourth_whole">
				<div id="history-heading">
					<h1 class="history-heading">History Specials</h1>
					<center><hr class="blue-divider-curve"></center>
				</div>
			...
			<?php if ($page['sixth_first_top'] || $page['sixth_second_top']): ?>
				...
				<?php if ($page['sixth_second_top']): 
 				...
 				<a class="view-all" href="/CHRONICLE" title="View More History Specials">more&nbsp;&nbsp;<i class="fas fa-angle-double-right"></i></a>
 				</div>
			<?php endif; ?>
			</div>
		</div>
